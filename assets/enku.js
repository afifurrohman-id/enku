...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_instanceof_HtmlLabelElement_ff1516be8a7e0767 = function(arg0) {
        let result;
        try {
    ...
    imports.wbg.__wbg_htmlFor_47615a914db76b58 = function(arg0, arg1) {
        const ret = getObject(arg1).htmlFor;
        const ptr1 = passStringToWasm0(ret, wasm.__wbindgen_export_0, wasm.__wbindgen_export_1);
        const len1 = WASM_VECTOR_LEN;
        getInt32Memory0()[arg0 / 4 + 1] = len1;
        getInt32Memory0()[arg0 / 4 + 0] = ptr1;
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('enku_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
